...
namespace TLSP.Common.Logging
{
    ...
    public static class InternalLoggerFactory
    {
        ...
        class DefaultLogFactory : ILoggerFactory
        {
            ILoggerProvider provider  = new EventSourceLoggerProvider();
        ...
        {
            ILoggerFactory f = new DefaultLogFactory();
