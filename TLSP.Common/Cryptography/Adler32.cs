...
namespace TLSP.Common.Checksum
{
	/// <summary>
	...
	///    checksum of zero.)"
	/// </summary>
	/// <see cref="TLSP.SharpZipLib.Zip.Compression.Streams.InflaterInputStream"/>
	/// <see cref="TLSP.SharpZipLib.Zip.Compression.Streams.DeflaterOutputStream"/>
